...
CONFIG = {
    ...
    "ibkr_port": int(os.environ.get("IBKR_PORT", "7496")),  # 7496=TWS, 4002=IB Gateway paper
    "ibkr_client_id": 10,
    ...
    "entry_gate": {
        ...
        # Tier D candidates flow through the standard entry_gate validation
        # identically to all other candidates (POSITION/SWING/INTRADAY).
...
_REQUIRED_KEYS: list[tuple] = [
    ...
    ("ml_data_dir",                     str,          "path to ML canonical evidence ledgers directory"),
]
