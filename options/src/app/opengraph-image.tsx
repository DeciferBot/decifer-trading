...
export const alt = "Decifer Options Flow";
  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "72px 80px", background: "#080d1a", fontFamily: "monospace" }}>
        ...
        <div style={{ color: "#f8fafc", fontSize: 56, fontWeight: 700, lineHeight: 1.1, marginBottom: 24 }}>Options Flow</div>
        <div style={{ color: "#94a3b8", fontSize: 24, lineHeight: 1.5, maxWidth: 680 }}>Real-time unusual options flow across a 1,000 symbol universe.</div>
