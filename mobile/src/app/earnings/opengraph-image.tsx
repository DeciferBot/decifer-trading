...
export const alt = "Decifer Earnings Calendar";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function EarningsOGImage() {
    ...
    (
      ...
      >
        ...
        <div style={{ color: "#94a3b8", fontSize: 24, lineHeight: 1.5, maxWidth: 680 }}>
          Upcoming earnings for tracked stocks — with theme context and signal coverage.
        </div>
