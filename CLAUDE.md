...
- **Test suite**: 3008 passing (2026-05-21). 11 pre-existing failures (6 test_quota_policy_promotion, test_cap_at_one, 4 test_signal_validation_report — all pre-existing, unrelated to ML sprints). Sprint 3.7 added 16 tests.
