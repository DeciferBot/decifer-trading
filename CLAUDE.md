...
- **Phase C / D — Pending Amit approval**: ML engine activation (ML gate = 50 trades, already met).
...
- **Test suite**: 2931 passing (2026-05-20). 8 pre-existing failures (test_quota_policy_promotion, unrelated). +64 new tests this session (29 signal validation + 35 walk-forward calibration).
