...
_cfg = {
    ...
    "high_conviction_score": 30, "atr_stop_multiplier": 1.5,
    "min_reward_risk_ratio": 1.5, "max_single_position": 0.20,
...
_AAPL_SIGNAL = {
    ...
    "timeframes": {
        "5m": {
            "signal": "BUY", "mfi": 70, "rsi_slope": 2.0, "macd_accel": 0.5,
            "bull_aligned": True, "bear_aligned": False, "adx": 35,
            "trend_strength": "strong", "squeeze_on": False, "squeeze_intensity": 0,
            "vwap_dist": 0.5, "donch_breakout": 1, "obv_slope": 1,
        },
        "1d": {"signal": "BUY"},
        "1w": None,
    },
    "score_breakdown": {
        "directional": 8, "momentum": 5, "squeeze": 4,
        "flow": 6, "breakout": 7, "news": 5,
    },
    "news": {},
}
...
class TestAgentTechnical:
    ...
    def test_divergence_detected_for_distribution_trap(self):
        ...
        trap_sig = {**_AAPL_SIGNAL,
                    "timeframes": {**_AAPL_SIGNAL["timeframes"],
                                   "5m": {**_AAPL_SIGNAL["timeframes"]["5m"],
                                          "obv_slope": -1, "mfi": 30}}}
