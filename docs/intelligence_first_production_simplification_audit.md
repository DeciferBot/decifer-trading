...
| `intelligence_schema_validator.py` | Advisory/shadow-only (tooling) | No | Extended with `validate_handoff_publisher_observation_report` wired into `validate_all()`. |
